...
$order_arabica = get_order_data('ARABICA');
$order_robusta = get_order_data('ROBUSTA');
$order_sumatra = get_order_data('SUMATRA');
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <li class="nav-item dropdown dropdown-order active">
    ...
    <div class="container order-page">
        <div class="order-content">
            <div class="product-item-container">
                <h1>{{$order_arabica->name}}</h1>
                <img src="{{Storage::url($order_arabica->image)}}" alt="">
                <h2 class="product-price">Rp {{$order_arabica->price}}</h2>
                <input type="number" class="quantity-input" value="0">
            </div>

            <div class="product-item-container">
                <h1>{{$order_robusta->name}}</h1>
                <img src="{{Storage::url($order_robusta->image)}}" alt="">
                <h2 class="product-price">Rp {{$order_robusta->price}}</h2>
                <input type="number" class="quantity-input" value="0">
            </div>

            <div class="product-item-container">
                <h1>{{$order_sumatra->name}}</h1>
                <img src="{{Storage::url($order_sumatra->image)}}" alt="">
                <h2 class="product-price">Rp {{$order_sumatra->price}}</h2>
                <input type="number" class="quantity-input" value="0">
            </div>
        </div>
    ...
    <footer class="footer">
        ...
        <div class="container-fluid container-fluid-footer-third">
        </div>
    </footer>
